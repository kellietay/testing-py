...
def is_mel(name, email):
    ...
    if name.lower() == "mel" or name.lower() == "mel melitpolski":
        return False
    elif email.lower() == "mel@ubermelon.com":
        return False
    else:
        return True 
...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'},{'type': 'wine'},{'type': 'donut'},]
    ...
    >>> treats = [{'type': 'dessert'},{'type': 'dessert'},{'type': 'wine'},{'type': 'wine'},{'type': 'donut'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'donut')
